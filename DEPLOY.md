...
| `/api/cron/reviews` | — nothing to schedule. Articles are flagged for review inside the watch and ingest ticks above, and the count is reported by the daily digest. The queue is at `/admin/sources`. |
