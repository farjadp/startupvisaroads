...
Camera: a 35mm or 50mm prime on a full-frame body, around f/4, shot at eye level or slightly above, natural hand-held framing. Real optical falloff at the edges, honest sensor grain, one or two surfaces slightly dusty, scuffed or fingerprinted. It must read as a frame a photographer took on assignment, not as a picture a computer made.
ABSOLUTELY NOT: 3D render, CGI, digital illustration, matte painting, game asset, stock-photo gloss, HDR compositing, plastic or waxy surfaces, impossibly clean geometry, toys or miniatures, or anything with the smooth synthetic sheen of a generated image. If the frame looks manufactured, it is wrong.
Subject: ONE clear real-world detail, object, material or space, slightly off-centre, with room breathing around it. Medium-close. ONE subject and at most one secondary object — never a tableau of three or four arranged props, and never a set that looks styled for a catalogue. Most of the frame is empty surface, wall, floor or air. Draw from: architecture and thresholds (doorways, staircases, handrails, glass, concrete, brick), city and transit detail (platforms, benches, crossings, bicycles, luggage, a coat on a hook), interiors stripped back (an empty room, a windowsill, a chair, a plant against a plain wall), and materials (linen, wool, matte metal, unglazed ceramic, stone). Never a wide establishing skyline, no posed professional, no meeting room, no handshake, nobody looking at the camera; when a person appears it is a hand or a partial figure at the edge of the frame.
...
Palette: cool and desaturated overall — off-white, bone, pale grey, and the deep near-black of ink (#1a1a1a) in shadows and objects. Muted, almost monochrome. NEUTRAL grey, not a tinted one: no warm orange, amber, golden, brown or sepia cast, and equally no green, mint, teal or blue cast washing the whole frame. Greys read as grey; white walls read as white.
