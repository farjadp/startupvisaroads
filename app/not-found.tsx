...
export default function GlobalNotFound() {
  return (
    <html lang="en">
      <body className="min-h-screen flex items-center justify-center relative overflow-hidden bg-black text-white selection:bg-white/30 font-sans">
        ...
        <div className="relative z-10 w-full max-w-4xl px-6 flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center md:text-start space-y-8 relative">
            ...
            <h1 className="text-6xl md:text-8xl tracking-tight font-light leading-none">
              404
              <span className="block text-3xl md:text-5xl mt-2 text-white/50">Destination Unknown</span>
            </h1>

            <p className="text-lg text-white/60 max-w-md mx-auto md:mx-0 leading-relaxed">
              It looks like you've navigated off the map. This route might be under construction or doesn't exist in our immigration catalog.
            </p>
