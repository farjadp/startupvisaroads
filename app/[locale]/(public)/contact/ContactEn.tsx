            ...
            <div className="lg:col-span-4 bg-[#1a1a1a] text-[#F2F0E9] flex flex-col justify-between">
               ...
               <div className="p-12">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-8 border-t border-[#F2F0E9]/20">
                     <a href="https://www.linkedin.com/company/ashavid/" className="flex items-center gap-2 hover:text-[#CCFF00] transition-colors font-sans text-sm uppercase tracking-widest">
                        <ArrowDownLeft className="w-4 h-4" /> LinkedIn
                     </a>
                     <a href="https://www.instagram.com/ashavidgroup/#" className="flex items-center gap-2 hover:text-[#CCFF00] transition-colors font-sans text-sm uppercase tracking-widest">
               ...
               <form onSubmit={handleSubmit} className="space-y-0">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border-t border-l border-r border-[#1a1a1a]/10">
                     <div className="group border-b border-[#1a1a1a]/10 p-6 focus-within:bg-[#F9F9F9] transition-colors relative">
                        ...
                        <input required name="name" type="text" className="w-full bg-transparent font-serif text-2xl focus:outline-none placeholder:text-[#1a1a1a]/10" placeholder="Your Name" />
                     </div>
                     <div className="group border-b border-[#1a1a1a]/10 p-6 focus-within:bg-[#F9F9F9] transition-colors relative">
                        ...
                        <input name="company" type="text" className="w-full bg-transparent font-serif text-2xl focus:outline-none placeholder:text-[#1a1a1a]/10" placeholder="Current Venture" />
                     </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border-l border-r border-[#1a1a1a]/10">
                     <div className="group border-b border-[#1a1a1a]/10 p-6 focus-within:bg-[#F9F9F9] transition-colors relative">
                        ...
                        <input required name="email" type="email" className="w-full bg-transparent font-serif text-2xl focus:outline-none placeholder:text-[#1a1a1a]/10" placeholder="email@domain.com" />
                     </div>
                     <div className="group border-b border-[#1a1a1a]/10 p-6 focus-within:bg-[#F9F9F9] transition-colors relative">
                        ...
                        <input required name="phone" type="tel" className="w-full bg-transparent font-serif text-2xl focus:outline-none placeholder:text-[#1a1a1a]/10" placeholder="+1 ..." />
                     </div>
                  </div>
                  ...
                  <div className="group border-x border-b border-[#1a1a1a]/10 p-6 focus-within:bg-[#F9F9F9] transition-colors relative">
                     ...
                     <select name="objective" className="w-full bg-transparent font-serif text-2xl focus:outline-none cursor-pointer appearance-none">
                  ...
                  <div className="group border-x border-b border-[#1a1a1a]/10 p-6 focus-within:bg-[#F9F9F9] transition-colors relative h-64">
                     ...
                     <textarea required name="brief" className="w-full h-full bg-transparent font-serif text-xl focus:outline-none resize-none placeholder:text-[#1a1a1a]/10 leading-relaxed" placeholder="Describe your business model, current traction, and capital availability..."></textarea>
                  </div>
