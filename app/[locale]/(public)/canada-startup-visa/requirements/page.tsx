// ============================================================================
// Page: /fa/canada-startup-visa/requirements — Persian-only, no English twin.
// ============================================================================
...
import { page } from '@/content/fa/canada-startup-visa-requirements';
...
export default async function CanadaSuvRequirementsFa({ params }: Props) {
  const { locale } = await params;
  ...
  return (
    <FaPageLayout
      ...
      trail={[
        ...
        { name: 'شرایط و مدارک', path: page.path },
      ]}
    />
  );
}
