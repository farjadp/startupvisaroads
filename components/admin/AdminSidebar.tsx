  ...
  return (
    <aside className="w-64 bg-[#1a1a1a] text-[#F2F0E9] min-h-screen flex flex-col fixed left-0 top-0 bottom-0 z-40 border-r border-[#333]">
      ...
      <div className="p-4 border-t border-[#333]">
        <button className="flex items-center gap-3 px-4 py-3 w-full text-left rounded-lg hover:bg-red-500/10 text-red-400 hover:text-red-300 transition-colors font-sans text-sm">
