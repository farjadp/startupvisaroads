...
export const meta = {
  ...
  description:
    'هفت سؤال درباره‌ی تیم، کسب‌وکار، زبان، سرمایه، سابقه و زمان‌بندی شما. خروجی: مسیر پیشنهادی از میان فنلاند، دانمارک، استونی، مسیرهای کارآفرینی آتلانتیک کانادا و EB-2 NIW — با دلیل، نه یک فرم بی‌جواب.',
...
export const intro = {
  eyebrow: 'رایگان · ۷ سؤال · ۳ دقیقه',
  headline: 'کدام مسیر برای شما منطقی است؟',
  sub: 'این ارزیابی به شما نمی‌گوید «واجد شرایط هستید». به شما می‌گوید کدام یک از مسیرهای باز امروز — اروپا، آتلانتیک کانادا یا آمریکا — با وضعیت واقعی‌تان می‌خواند، چرا، و چه چیزی هنوز کم است. گاهی پاسخ درست «هنوز زود است» است — و آن هم یک پاسخ است.',
  start: 'شروع ارزیابی',
...
export const questions: Question[] = [
  ...
  {
    id: 'team',
    title: 'تنها هستید یا هم‌بنیان‌گذار دارید؟',
    hint: 'فنلاند دست‌کم دو بنیان‌گذار می‌خواهد؛ دانمارک و استونی بنیان‌گذار تنها را می‌پذیرند.',
    options: [
      { value: 'solo', label: 'تنها هستم' },
      { value: 'team', label: 'یک یا چند هم‌بنیان‌گذار جدی دارم', detail: 'با نقش واقعی و قصد مهاجرت' },
    ],
  },
  {
    id: 'business',
